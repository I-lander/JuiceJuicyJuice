...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'prestige.startJuice.desc': '+1000 juice at game start',
    'prestige.spriteYield.name': 'Sprite Yield',
    'prestige.spriteYield.desc': '+20% juice per sprite',
  ...
  fr: {
    ...
    'prestige.startJuice.desc': '+1000 jus au depart',
    'prestige.spriteYield.name': 'Rendement Sprite',
    'prestige.spriteYield.desc': '+20% jus par sprite',
