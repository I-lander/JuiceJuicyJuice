...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'upgrade.addSprite.desc': '+1 sprite (generates juice passively)\n+{cpu} CPU/sprite, +{juice} juice/s/sprite',
    'upgrade.bounce.desc': 'Sprites pulse every 5s\n+{cpu} CPU/sprite, +{juice} juice/s/sprite',
  ...
  fr: {
    ...
    'upgrade.addSprite.desc': '+1 sprite (genere du jus passif)\n+{cpu} CPU/sprite, +{juice} jus/s/sprite',
    'upgrade.bounce.desc': 'Pulsation des sprites toutes les 5s\n+{cpu} CPU/sprite, +{juice} jus/s/sprite',
