...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'upgrade.bounceJuiceUp.desc': '+50 juice/s per sprite (bounce)',
    'upgrade.movementJuiceUp.desc': '+500 juice/s per sprite (movement)',
    'upgrade.rotationJuiceUp.desc': '+50K juice/s per sprite (rotation)',
  ...
  fr: {
    ...
    'upgrade.bounceJuiceUp.desc': '+50 jus/s par sprite (rebond)',
    'upgrade.movementJuiceUp.desc': '+500 jus/s par sprite (mouvement)',
    'upgrade.rotationJuiceUp.desc': '+50K jus/s par sprite (rotation)',
